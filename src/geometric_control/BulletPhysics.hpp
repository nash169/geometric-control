...
namespace geometric_control {
    ...
    class BulletPhysics : public Platform::Application {
    public:
        explicit BulletPhysics(const Arguments& arguments);
    ...
    BulletPhysics::BulletPhysics(const Arguments& arguments) : Platform::Application(arguments, NoCreate)
    {
       ...
       MSAA if we have enough DPI. */
        ...
        _shader = Shaders::Phong{
            Shaders::Phong::Flag::VertexColor | Shaders::Phong::Flag::InstancedTransformation};
    ...
    void BulletPhysics::keyPressEvent(KeyEvent& event)
    {
        /* Movement */
    ...
    void BulletPhysics::mousePressEvent(MouseEvent& event)
    {
