...
#include "../interfaces/CommonWindowInterface.h"
...
static const char* triangleVertexShaderText = "#version 330\n"
        ...
        for (int j = 0; j < textureHeight / 2; j++) {
            for (int i = 0; i < textureWidth; i++) {
                for (int c = 0; c < numComponents; c++) {
                    ...
                    pixels[(j * textureWidth + i) * numComponents + c] = pixels[((textureHeight - j - 1) * textureWidth + i) * numComponents + c];
