...
#include "../../interfaces/CommonFileIOInterface.h"
#include "../../interfaces/CommonGUIHelperInterface.h"
#include "../../interfaces/CommonRenderInterface.h"
#include "../../thirdparty/Wavefront/tiny_obj_loader.h"
...
int BulletURDFImporter::convertLinkVisualShapes(int linkIndex, const char* pathPrefix, const btTransform& localInertiaFrame) const
{
    ...
    if (linkPtr) {
        ...
        for (int v = 0; v < link->m_visualArray.size(); v++) {
            ...
            if ((meshData.m_flags & B3_IMPORT_MESH_HAS_RGBA_COLOR) && (meshData.m_flags & B3_IMPORT_MESH_HAS_SPECULAR_COLOR)) {
