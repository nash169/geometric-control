...
#include "../../interfaces/CommonParameterInterface.h"
...
#include "../../interfaces/CommonMultiBodyBase.h"
                ...
                if (1) {
                    ...
                    for (int i = 0; i < num6Dof; i++) {
                        ...
                        if (c->getUserConstraintPtr()) {
                            ...
                            if ((jointInfo->m_urdfJointType == URDFRevoluteJoint) || (jointInfo->m_urdfJointType == URDFPrismaticJoint) || (jointInfo->m_urdfJointType == URDFContinuousJoint)) {
